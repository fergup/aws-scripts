...
cat $SCFILE| awk -F'\t' '($21=="server"||$21=="pdu"||$21=="switch"||$21=="router"||$21=="loadbalancer"||$21=="firewall"||$21=="sanarray"||$21=="sanswitch")&&($19=="Installed-Active")&&($10=="SUNGARD CLOUD PLATFORM")&&($20=="Monitor Only"||$20=="Managed")&&($2!="")  { print $2","$8","$21 }' |sort -k 2|uniq >$SCMIN
...
WINSAOK=0
rm $NOTINZN
for WIN in $(cat $SCFILE|awk -F'\t' '($8=="WINDOWS"||$8=="Windows"||$8=="Windows 2003"||$8=="WINDOWS 2003 X64"||$8=="WINDOWS X64"||$8=="t-win-2008r2-std-rtm-full-01f")&&($12 ~ "GB:")&&($10=="SUNGARD CLOUD PLATFORM")&&($21=="server")&&($20=="Monitor Only"||$20=="Managed")&&($19=="Installed-Active") { print $2 }'|sed 's/ //g' |sed '/^$/d')
	do
...
rm $MAILFILE 
printf "
<span style='font-family:arial;font-weight:bold'><table><tr><td><H2>Windows</H2></td><td><img src="http://www.sigmasolinc.com/wp-content/uploads/2014/04/sungardAS-logo.png" height="80"></td></tr></table></span>
...
$WINSCREP
<img src="http://www.sigmasolinc.com/wp-content/uploads/2014/04/sungardAS-logo.png">
" >> $MAILFILE
