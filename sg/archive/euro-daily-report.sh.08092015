...
mutt -e 'set content_type="text/html"' "paul.ferguson@sungardas.com,sanjay.d.deshpande@sungardas.com,pushkar.shirolkar@sungardas.com" -s " European Daily Report on $DAY" -a $EUTIXGRAPH -a $UKTIXGRAPH -a $IETIXGRAPH -a $SETIXGRAPH $FRTIXGRAPH -a $PDF < $HTMAILFILE
