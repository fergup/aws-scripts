...
" > $MAILFILE
printf "<b>Incidents</b><br><span style='font-family:arial;text-align: center'><table border='1'>" > $MAILFILE
...
#mutt  -e 'set content_type="text/html"' "paul.ferguson@sungardas.com,ryan.bell@sungardas.com"  -s "Menzies Status Change Report" < $MAILFILE
# Archive
#cp $SCYEST $SCYESTSAV
