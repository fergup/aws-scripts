...
RRDFILE=/data/rrd/toc_daily.rrd
...
echo "</table>" >> $MAILFILE
# Send me mail
#mutt  -e 'set content_type="text/html"' "as.toc.mgmt@sungardas.com,pushkar.shirolkar@sungardas.com,jan.clayton-adamson@sungardas.com,charles.ernst@sungardas.com,luis.andujar@sungardas.com,scott.tarr-whelan@sungardas.com,as.us.change-implementation.management@sungardas.com,tony.rodriguez@sungardas.com" -s "Daily Service Center Status Change Report" < $MAILFILE
mutt  -e 'set content_type="text/html"' "paul.ferguson@sungardas.com"  -s "Daily Service Center Status Change Report" < $MAILFILE
# Archive
cp $SCYEST $SCYESTSAV
