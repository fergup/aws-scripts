...
mutt -e 'set content_type="text/html"' "paul.ferguson@sungardas.com,xande.craveiro-lopes@sungardas.com,jan.clayton-adamson@sungardas.com,christopher.hanchey@sungardas.com,joseph.ruzicka@sungardas.com,tim.johnston@sungardas.com"  -s "### Daily Global Open Ticket Report ###" < $MAILFILE 
