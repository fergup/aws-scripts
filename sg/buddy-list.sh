...
buddydub 50;buddy 32;buddy 33;teamall 50 32 33;teammail 50 32 33
printf "</tr>
...
mutt -e 'set content_type="text/html"' "paul.ferguson@sungardas.com,as.toc.mgmt@sungardas.com,xande.craveiro-lopes@sungardas.com,jan.clayton-adamson@sungardas.com"  -s "### Daily TOC Buddy List for $DDATE ###" < $MAILFILE 
