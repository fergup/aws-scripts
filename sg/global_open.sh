...
EU20=$(cat $OPEN|awk -F'","' '($18~"Incident")&&(($22~"Europe")||($24~"Europe"))&&($5!~"Resolved")&&($20>1728000) { print $0 }'|wc -l)
EU15=$(cat $OPEN|awk -F'","' '($18~"Incident")&&(($22~"Europe")||($24~"Europe"))&&($5!~"Resolved")&&($20>1296000) { print $0 }'|wc -l)
EU10=$(cat $OPEN|awk -F'","' '($18~"Incident")&&(($22~"Europe")||($24~"Europe"))&&($5!~"Resolved")&&($20>864000) { print $0 }'|wc -l)
EUCOMP=$(cat $OPEN|awk -F'","' 'BEGIN{IGNORECASE=1} ($10~"compute|unix|window")&&(($22~"Europe")||($24~"Europe"))&&($18~"Incident")&&($5!~"Resolved")&&($20>1296000) { print $0 }'|wc -l)
EUNET=$(cat $OPEN|awk -F'","' 'BEGIN{IGNORECASE=1} ($10~"net")&&(($22~"Europe")||($24~"Europe"))&&($18~"Incident")&&($5!~"Resolved")&&($20>1296000) { print $0 }'|wc -l)
EUSTOR=$(cat $OPEN|awk -F'","' 'BEGIN{IGNORECASE=1} ($10~"stor")&&(($22~"Europe")||($24~"Europe"))&&($18~"Incident")&&($5!~"Resolved")&&($20>1296000) { print $0 }'|wc -l)
EUOTH=$(cat $OPEN|awk -F'","' 'BEGIN{IGNORECASE=1} ($10!~"stor|net|compute|unix|window")&&(($22~"Europe")||($24~"Europe"))&&($18~"Incident")&&($5!~"Resolved")&&($20>1296000) { print $0 }'|wc -l)
EUFS=$(cat $OPEN|awk -F'","' 'BEGIN{IGNORECASE=1} (($22~"Europe")||($24~"Europe"))&&($18~"Incident")&&($5!~"Resolved")&&($20>1296000)&&($23~"true") { print $0 }'|wc -l)
EUNOFS=$(cat $OPEN|awk -F'","' 'BEGIN{IGNORECASE=1} (($22~"Europe")||($24~"Europe"))&&($18~"Incident")&&($5!~"Resolved")&&($20>1296000)&&($23!~"true") { print $0 }'|wc -l)
US20=$(cat $OPEN|awk -F'","' '($18~"Incident")&&(($22~"US")||($24~"US"))&&($5!~"Resolved")&&($20>1728000) { print $0 }'|wc -l)
US15=$(cat $OPEN|awk -F'","' '($18~"Incident")&&(($22~"US")||($24~"US"))&&($5!~"Resolved")&&($20>1296000) { print $0 }'|wc -l)
US10=$(cat $OPEN|awk -F'","' '($18~"Incident")&&(($22~"US")||($24~"US"))&&($5!~"Resolved")&&($20>864000) { print $0 }'|wc -l)
USCOMP=$(cat $OPEN|awk -F'","' 'BEGIN{IGNORECASE=1} ($10~"compute|unix|window")&&(($22~"US")||($24~"US"))&&($18~"Incident")&&($5!~"Resolved")&&($20>1296000) { print $0 }'|wc -l)
USNET=$(cat $OPEN|awk -F'","' 'BEGIN{IGNORECASE=1} ($10~"net")&&(($22~"US")||($24~"US"))&&($18~"Incident")&&($5!~"Resolved")&&($20>1296000) { print $0 }'|wc -l)
USSTOR=$(cat $OPEN|awk -F'","' 'BEGIN{IGNORECASE=1} ($10~"stor")&&(($22~"US")||($24~"US"))&&($18~"Incident")&&($5!~"Resolved")&&($20>1296000) { print $0 }'|wc -l)
USOTH=$(cat $OPEN|awk -F'","' 'BEGIN{IGNORECASE=1} ($10!~"stor|net|compute|unix|window")&&(($22~"US")||($24~"US"))&&($18~"Incident")&&($5!~"Resolved")&&($20>1296000) { print $0 }'|wc -l)
USFS=$(cat $OPEN|awk -F'","' 'BEGIN{IGNORECASE=1} (($22~"US")||($24~"US"))&&($18~"Incident")&&($5!~"Resolved")&&($20>1296000)&&($23~"true") { print $0 }'|wc -l)
USNOFS=$(cat $OPEN|awk -F'","' 'BEGIN{IGNORECASE=1} (($22~"US")||($24~"US"))&&($18~"Incident")&&($5!~"Resolved")&&($20>1296000)&&($23!~"true") { print $0 }'|wc -l)
# RRD things
...
rrdtool graph $RRDGRAPH -a PNG '--title=All Open Incidents - US' --vertical-label 'Number of Tickets' DEF:probe1=/data/rrd/sn_us.rrd:us20:AVERAGE DEF:probe2=/data/rrd/sn_us.rrd:us15:AVERAGE DEF:probe3=/data/rrd/sn_us.rrd:us10:AVERAGE 'AREA:probe3#FF0000:Over 10 days old' 'AREA:probe2#00FF00:Over 15 days old' 'AREA:probe1#0000FF:Over 20 days old' -w 600 -h 250 -n TITLE:13: --alt-y-grid -l 0 -s now-22w -e now+1d
# Create mail file
echo "" > $MAILFILE
printf "<head><style>
	table {
